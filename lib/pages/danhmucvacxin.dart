...
class _ProductPageState extends State<ProductPage> {
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 50,
                              height: 50,
                              child: Image(image: AssetImage(items[index].imageURL.toString()),fit: BoxFit.fill,),
                            ),
                            Expanded(child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(padding: EdgeInsets.only(left: 8,right: 8),child: Text(items[index].company.toString()),),
  ...
  Future<List<ProductDataModel>>ReadJsonData() async{
    final jsondata = await rootBundle.rootBundle.loadString('assets/jsonfile/vacxinlist.json');
